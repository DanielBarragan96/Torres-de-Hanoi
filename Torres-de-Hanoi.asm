...
COLI: 
	add $s2, $s2, 1		# se aumenta i (contador de columna actual)
...
DER: 
	...
	add $t6, $t6, -32	# si el valor no es cero se aumenta su dirección
...
IZQ: 
	...
	add $t7, $t7, -32	# si el valor no es cero se aumenta su dirección
